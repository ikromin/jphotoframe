...
public class ConfigDefaults {
    ...
    public static final String DEFAULT_DATE_OFFSET_X = "20";
    public static final String DEFAULT_DATE_OFFSET_Y = "10";
    public static final String DEFAULT_TIME_OFFSET_X = "30";
    ...
    public static final String DEFAULT_WEATHER_CONDITION_OFFSET_Y = "120";
